...
This project is indexed by GitNexus as **heretek** (2476 symbols, 4095 relationships, 214 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/heretek/context` | Codebase overview, check index freshness |
| `gitnexus://repo/heretek/clusters` | All functional areas |
| `gitnexus://repo/heretek/processes` | All execution flows |
| `gitnexus://repo/heretek/process/{name}` | Step-by-step execution trace |
