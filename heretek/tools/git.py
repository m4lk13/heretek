...
from heretek.utils import utc_now_iso, write_text, safe_relpath, run_cmd
...
def get_tools() -> List[ToolEntry]:
    return [
        ToolEntry("repo_write_commit", {
            ...
            "description": "Write one file + commit + push to heretek branch. For small deterministic edits.",
