"""Shell инструмент: run_shell.

Plan 03 strip note: the upstream `claude_code_edit` tool was removed because
it delegated edits to the Anthropic cloud CLI. Heretek is local-only — no
cloud LLM dependencies. Local code edits go through the local Ollama-driven
LLM loop using the standard repo_write_commit tool.
"""
...
from heretek.utils import utc_now_iso, append_jsonl, truncate_for_log
