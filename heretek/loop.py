...
from heretek.llm import LLMClient, normalize_reasoning_effort, add_usage
from heretek.tools.registry import ToolRegistry
from heretek.context import compact_tool_history, compact_tool_history_llm
from heretek.utils import utc_now_iso, append_jsonl, truncate_for_log, sanitize_tool_args_for_log, sanitize_tool_result_for_log, estimate_tokens
...
def _drain_incoming_messages(
    ...
    if drive_root is not None and task_id:
        from heretek.owner_inject import drain_owner_messages
...
def run_llm_loop(
    ...
    from heretek.tools import tool_discovery as _td
    ...
    try:
        ...
        if drive_root is not None and task_id:
            try:
                from heretek.owner_inject import cleanup_task_mailbox
